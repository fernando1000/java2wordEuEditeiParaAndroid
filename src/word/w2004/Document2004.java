...
public class Document2004 implements IDocument, IElement{
    ...
    private String author = "Fernando Santos";
    private String lastAuthor = "Fernando Santos";
    private String manager = "Fernando Santos";
    ...
    private String setUpPageOrientation(String txt) {
        if(isLandscape) {
            String orientation = 
            		...
            		"    <w:sectPr wsp:rsidR=\"00F04FB2\" wsp:rsidSect=\"00146B2A\">\n"
